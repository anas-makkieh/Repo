...
"void main()\n"
"{\n"
"   FragColor = vec4(0.35f, 0.3f, 0.1f, 1.0f);\n" // RGBA: خريوني
"}\n\0";
...
int main()
{
    ...
    float vertices[] = {
        -0.9f, -0.5f, 0.0f, // يسار أسفل
         0.9f, -0.5f, 0.0f, // يمين أسفل
        -0.9f,  0.5f, 0.0f,  // أعلى يسار
         0.9f,  0.5f, 0.0f  // أعلى يمين
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glDrawArrays(GL_TRIANGLE_STRIP, 0, 4); // ارسم مثلثاً من 3 رؤوس
